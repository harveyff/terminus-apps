...
{{- define "vllmdeepseekv4flashv3.engineArgs" -}}
{{- $in := . -}}
...
{{- end -}}
{{- end -}}
{{- /* vLLM engine image by accelerator — SM120 amd64 uses lucifer1004 image. */ -}}
{{- define "vllmdeepseekv4flashv3.engineImage" -}}
...
{{- if $isGb10 -}}
{{- $img.nvidiaGb10 | default "docker.io/vllm/vllm-openai:v0.26.0-aarch64" -}}
{{- else if eq $arch "arm64" -}}
{{- $img.nvidiaArm64 | default "docker.io/vllm/vllm-openai:v0.26.0-aarch64" -}}
{{- else -}}
{{- $img.nvidia | default "docker.io/lucifer1004/dsv4-flash-sm120:20260604" -}}
{{- end -}}
{{- end -}}
